...
export function render() {
  ...
  const content=eventScreens(screen,state)||projectScreens(screen,state,q.get('item'))||title('DESIGN ARTIFACT','Screen not found','Return to the event entrance.',link('access','Event entrance'));
