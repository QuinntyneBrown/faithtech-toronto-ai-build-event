...
export function dialogContent(id,item) {
  ...
  const definitions={
    'draw': ['Ready for a little celebration?',`<p>Draw from ${model.participants.length-model.winners.length} eligible participants. Previous winners will be excluded.</p><p class="muted">The review prototype uses a repeatable sample draw.</p>`,'Start the draw'],
