...
export function applyState(content,screen,state){
  if(state==='loading')return title('GETTING THINGS READY','One moment.','We’re preparing this part of your evening.')+`<div class="cs-stack" aria-busy="true" aria-label="Loading event content"><span class="cs-skeleton"></span><span class="cs-skeleton"></span><span class="cs-skeleton"></span></div><div class="section">${link(screen,'Show loaded screen')}</div>`;
