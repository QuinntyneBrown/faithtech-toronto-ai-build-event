...
namespace FaithTechTorontoAiBuildEvent.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909020435_OperatorAttribution")]
    partial class OperatorAttribution
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FaithTechTorontoAiBuildEvent.Domain.Operations.OperationReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ActorKind", "ActorId", "EventId", "OperationId")
                        .IsUnique();

                    b.ToTable("OperationReceipts");
                });

            modelBuilder.Entity("FaithTechTorontoAiBuildEvent.Domain.Operations.OperatorIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FaithTechTorontoAiBuildEvent.Infrastructure.Access.AuthenticationFailure", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("AccountKey", "FailedAtUtc");

                    b.HasIndex("SourceKey", "FailedAtUtc");

                    b.ToTable("AuthenticationFailures");
                });
            ...
            modelBuilder.Entity("FaithTechTorontoAiBuildEvent.Domain.Access.AdministratorSession", b =>
                {
                    b.HasOne("FaithTechTorontoAiBuildEvent.Infrastructure.Access.AdministratorAccount", null)
                        .WithMany()
