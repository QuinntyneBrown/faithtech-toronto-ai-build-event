...
import { SESSION_SERVICE, EVENT_SERVICE, SCHEDULE_SERVICE, ROSTER_SERVICE } from '@faithtech/api';
import { MockRosterService } from '../../../api/testing/mock-roster.service';
...
export const serviceProviders: Provider[] = [
  ...
  { provide: ROSTER_SERVICE, useClass: MockRosterService },
];
